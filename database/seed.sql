...
-- Roles
INSERT INTO `pidl`.`role` VALUES (1, 'Admin', 'System administrator');
INSERT INTO `pidl`.`role` VALUES (2, 'Student', 'User with limited rights');
INSERT INTO `pidl`.`role` VALUES (3, 'Researcher', 'User involved in model optimization');

-- Resources
INSERT INTO `pidl`.`resource` VALUES (1, 'GPU Workstation A', 'Intel Xeon', 16, 64, 3.60, 450, 'High-performance training workstation');
INSERT INTO `pidl`.`resource` VALUES (2, 'Edge Device X', 'ARM Cortex', 4, 8, 1.80, 45, 'Low-power evaluation device');
INSERT INTO `pidl`.`resource` VALUES (3, 'Cloud Server Z', 'AMD EPYC', 32, 256, 2.90, 700, 'Cloud-based optimization server');

-- Tasks
INSERT INTO `pidl`.`task` VALUES (1, 'Image Classification', 'Assign labels to images');
INSERT INTO `pidl`.`task` VALUES (2, 'Object Detection', 'Detect and localize objects');
...
-- Evaluations
INSERT INTO `pidl`.`evaluation` VALUES 
...
-- Optimizations 
INSERT INTO `pidl`.`optimization` VALUES 
