...
class Quantization(models.Model):
    ...
    quantization_model_size_reduction = models.DecimalField(max_digits=5, decimal_places=3, blank=True, null=True)
    quantization_memory_reduction = models.DecimalField(max_digits=5, decimal_places=3, blank=True, null=True)
...
class Pruning(models.Model):
    ...
    pruning_compression_ratio = models.DecimalField(max_digits=5, decimal_places=3, blank=True, null=True)
    pruning_memory_reduction = models.DecimalField(max_digits=5, decimal_places=3, blank=True, null=True)
