...
class Pruning(models.Model):
    ...
    pruning_scope = models.CharField(max_length=50, blank=True, null=True)
...
class KnowledgeDistillation(models.Model):
    ...
    knowledge_distillation_description = models.CharField(max_length=100, blank=True, null=True)
