...
const Dashboard = () => {
    ...
    // Fonction pour filtrer les donn�es en fonction des crit�res s�lectionn�s
...
const styles = StyleSheet.create({
    ...
    logoutButton: {
        backgroundColor: '#ff4444', // Rouge pour le bouton de d�connexion
        padding: 10,
        borderRadius: 5,
        marginTop: 20,
    },
